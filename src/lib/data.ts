...
export const publishers: Publisher[] = [
  { id: 'pub_1', name: 'Alpha Media', email: 'contact@alphamedia.com', avatarUrl: 'https://picsum.photos/seed/1/40/40', paymentMethod: 'PayPal', status: 'Active', joiningDate: '2023-01-15' },
  { id: 'pub_2', name: 'Beta Digital', email: 'accounts@betadigital.com', avatarUrl: 'https://picsum.photos/seed/2/40/40', paymentMethod: 'Bank Transfer', status: 'Active', joiningDate: '2023-02-20' },
  { id: 'pub_3', name: 'Gamma Group', email: 'info@gammagroup.com', avatarUrl: 'https://picsum.photos/seed/3/40/40', paymentMethod: 'Payoneer', status: 'Inactive', joiningDate: '2022-11-05' },
  { id: 'pub_4', name: 'Delta Solutions', email: 'support@deltasols.com', avatarUrl: 'https://picsum.photos/seed/4/40/40', paymentMethod: 'PayPal', status: 'Active', joiningDate: '2023-05-10' },
  { id: 'pub_5', name: 'Epsilon Ads', email: 'admin@epsilonads.com', avatarUrl: 'https://picsum.photos/seed/5/40/40', paymentMethod: 'Bank Transfer', status: 'Active', joiningDate: '2023-03-22' },
];

export const offers: Offer[] = [
  { id: 'offer_1', name: 'Summer Sale Campaign', platform: 'AdPlatform X', payout: 500, status: 'Live', startDate: '2023-06-01' },
  { id: 'offer_2', name: 'Q4 Bonanza', platform: 'AdPlatform Y', payout: 750, status: 'Live', startDate: '2023-10-01' },
  { id: 'offer_3', name: 'Spring Fling', platform: 'AdPlatform X', payout: 400, status: 'Paused', startDate: '2023-04-01' },
  { id: 'offer_4', name: 'New Year Blast', platform: 'AdPlatform Z', payout: 1200, status: 'Expired', startDate: '2023-01-01' },
  { id: 'offer_5', name: 'Holiday Special', platform: 'AdPlatform Y', payout: 950, status: 'Live', startDate: '2023-11-15' },
];
