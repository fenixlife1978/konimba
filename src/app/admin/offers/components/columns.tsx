...
const DeleteConfirmationDialog = ({ offer, onConfirm }: { offer: GlobalOffer, onConfirm: () => void }) => {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <span className="font-semibold"> {offer.name}</span> del catálogo global.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
...
export const columns: ColumnDef<GlobalOffer>[] = [
  {
    accessorKey: 'name',
      ...
      const handleDelete = async () => {
        try {
          ...
          toast({
            ...
            description: `La oferta "${offer.name}" ha sido eliminada del catálogo.`,
          });
        } catch (error) {
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DropdownMenu>
           ...
           <DialogContent className="sm:max-w-xl">
            <DialogHeader>
              <DialogTitle>Editar Oferta del Catálogo</DialogTitle>
            </DialogHeader>
            <OfferForm 
              initialData={offer} 
